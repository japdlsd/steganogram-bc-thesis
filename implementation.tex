...
We use AES-256 algorithm in CBC mode with a zero initial vector (IV). These are the default
...
to test their mutually inversibility exhaustively (i.e. on every possible input).
